...
thickness = st.number_input("Enter Slab Thickness (mm):", min_value=0.0, step = 10.0 )
Cx = st.number_input("Enter Cx (mm):", min_value=0.0, step = 10.0 )
Cy = st.number_input("Enter Cy (mm):", min_value=0.0, step = 10.0 )
